...
export default function App() {
  return (
    <div className="min-h-screen bg-[#0f0f11] text-white font-sans selection:bg-purple-500/30">
      ...
      <main>
        {/* Hero Section */}
        <section id="inicio" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 text-purple-400 text-sm font-medium mb-8 border border-purple-500/20"
          >
              ...
              <div key={i} className="group cursor-pointer">
                <div className="aspect-video rounded-xl bg-white/5 border border-white/10 mb-4 overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <BookOpen className="w-8 h-8 text-white/20 group-hover:text-purple-400/50 transition-colors" />
                  </div>
                </div>
